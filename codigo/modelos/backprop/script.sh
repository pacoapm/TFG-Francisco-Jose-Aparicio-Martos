...
python mnist_backprop_qtp.py --epochs 10 --dataset MNIST --n-bits 2 --global-quantization 0
python mnist_backprop_qtp.py --epochs 10 --dataset MNIST --n-bits 2 --global-quantization 1
...
python mnist_backprop_qtp.py --epochs 10 --dataset FMNIST --n-bits 2 --global-quantization 0
python mnist_backprop_qtp.py --epochs 10 --dataset FMNIST --n-bits 2 --global-quantization 1
