...
python mnist_backprop_qtp.py --epochs 10 --dataset MNIST --n-bits 6 --global-quantization 0 --modo 1
python mnist_backprop_qtp.py --epochs 10 --dataset MNIST --n-bits 6 --global-quantization 1 --modo 1
...
python mnist_backprop_qtp.py --epochs 10 --dataset FMNIST --n-bits 6 --global-quantization 0 --modo 1
python mnist_backprop_qtp.py --epochs 10 --dataset FMNIST --n-bits 6 --global-quantization 1 --modo 1
